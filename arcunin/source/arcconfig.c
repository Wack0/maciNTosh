...
// Dummy PCI buses, some NT code only will check the number of PCI buses present in the ARC device tree.
// There are at least 3 in uni-north systems, some uni-north systems (G4 MDD) have at least 4.


static DEVICE_ENTRY Pci4 = {
    .Component = ARC_MAKE_COMPONENT(AdapterClass, MultiFunctionAdapter, ARC_DEVICE_NONE, 4, 0),
    .Parent = &Root,
    .Peer = &MacIO,
};


static DEVICE_ENTRY Pci3 = {
    .Component = ARC_MAKE_COMPONENT(AdapterClass, MultiFunctionAdapter, ARC_DEVICE_NONE, 3, 0),
    .Parent = &Root,
    .Peer = &Pci4,
};
...
static const char s_RootIdentifier[] = "Mac99";
...
void ArcConfigInit(void) {
    ...
    Pci3.Component.Identifier = (size_t)s_PciIdentifier;
    Pci3.Component.IdentifierLength = sizeof(s_PciIdentifier);
    Pci4.Component.Identifier = (size_t)s_PciIdentifier;
    Pci4.Component.IdentifierLength = sizeof(s_PciIdentifier);
    // ...and MIO identifier
